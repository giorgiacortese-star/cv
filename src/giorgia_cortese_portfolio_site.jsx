...
const projects = [
  ...
  const education = [
    ...
    },
    {
      ...
      details:
        "Core exams included Transport Phenomena, Introduction to Sustainable Process Engineering, Solid and Structural Mechanics, and Fundamentals in Computer Science. Thesis on photoprotective creams, mapping industrial processes from biomass to sunscreens with Caudalie and ISDIN as case studies. Student selected for mentorship programme, merit based.",
    },
  ];
